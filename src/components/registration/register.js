...
const RegisterPage = () => {
    return (
        <form class="border border-light p-5">
            ...
            <select class="browser-default custom-select mb-4" id="country">
            ...
            <select class="browser-default custom-select mb-4" id="political">
                <option value="default" disabled="true" selected="">Political Affiliation</option>
